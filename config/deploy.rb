...
set :user, 'demo'
set :keep_releases, 3 
set :repository,  "git@github.com:benhall2121/swTucson.git" # replace neerajdotname with your github username
set :use_sudo, false
set :scm, :git
set :deploy_via, :copy
...
set :application, 'swTucson' # replace gitlearn with your application name
